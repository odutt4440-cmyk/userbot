...
async def retry_guesses(event):
    ...
    while waiting_next_turn:

        await asyncio.sleep(RETRY_INTERVAL)

        # next turn arrived
        if not waiting_next_turn:
            return

        # more guesses available
        if guess_index < len(current_answers):
...
async def main():
    ...
    print("===================================")
    print(" OCTOPUS USERBOT STARTED ")
    print("===================================\n")

    print("HOW TO USE:")
    print("1. Open any group")
    print("2. Send: /game@OctopusEN_Bot")
    print("3. Everything automatic")
    print("4. Auto answer")
    print("5. Auto skip")
    print("6. Auto learn\n")

    print("SAVED MESSAGE COMMANDS:")
    print("setdelay 1.0 1.5")
    print("setretry 3\n")
